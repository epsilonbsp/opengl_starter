...
// Texture pass: renders the heart SDF to the offscreen FBO
TEXTURE_VERTEX_SOURCE :: `#version 460 core
...
OUTPUT_FRAGMENT_SOURCE :: `#version 460 core
    ...
    void main() {
        o_frag_color = texture(u_scene, v_tex_coord);
    }
`
...
main :: proc() {
    ...
    texture_program, texture_program_ok := gl.load_shaders_source(TEXTURE_VERTEX_SOURCE, TEXTURE_FRAGMENT_SOURCE)
    ...
    // FBO color texture
    fbo_texture: u32; gl.GenTextures(1, &fbo_texture); defer gl.DeleteTextures(1, &fbo_texture)
